...
class _AddDeductionScreenState extends State<AddDeductionScreen> {
  ...
  String _selectedDeductionType = 'Tax';
  final List<String> _deductionTypes = [
    'Tax',
    'Provident Fund',
    'Absent Days',
    'Late Arrivals',
  ...
  void _submitDeduction() async {
    ...
    final result = await provider.addDeduction(
      employeeId: widget.employeeId,
      employeeType: widget.employeeType,
      deductionType: _selectedDeductionType,
      amount: amount,
    ...
    if (result == 'true') {
      SnackBarHelper.showSuccess('Deduction added successfully');
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: _deductionTypes.map((String type) {
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixText: 'Rs. ',
                      prefixIcon: const Icon(LucideIcons.minusCircle),
                  ...
                  TextFormField(
                    ...
                    maxLines: 4,
                    decoration: InputDecoration(
                      hintText: 'Enter deduction description/reason',
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
                      focusedBorder: OutlineInputBorder(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: provider.isLoading ? null : _submitDeduction,
